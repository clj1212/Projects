			...
			<div class="coat-row">
				<?php
					...
					$error = error_get_last();	
						...
						$sql="select picname,date,filepath,pichash from certification where user='$user' and status=0";
						...
						if (!$result) {
							...
							echo "
								<div class='coat-column'>
									...
									<div class='mask'>
										<div class='info'><a href='setprice.php?pichash=$pichash'>View</a></div>
									 </div>
								</div>";
