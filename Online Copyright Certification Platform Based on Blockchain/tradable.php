...
<section id="main">
	<div class="content">
		...
		<div class="logo"><a href="choosetrade.php">售出更多作品...</a></div>
...
$error = error_get_last();	
	...
	if (!$conn){                
		...
		for($x=0;$x<$arrlength;$x++) {
			echo "
					<div class='coats'>
					<h3 class='c-head'>".$t[$x]."</h3>
					<small><a href='getmoretra.php?style=".$s[$x]."'>Show More...</a></small>";
			echo "<div class='coat-row'>";
			$count=0;
			mysqli_set_charset( $conn,"utf8" );//使数据库中的数据以utf8格式显示在网页上
			$sql="select * from tradable where user='$user' and $s[$x]=1";
			...
			echo "
				<div class='coat-column'>
					<a href='$filepath'>
						...
						<div class='prod-desc'><h4>$picname</h4><small>&yen $price</small>
